                                ...
                                <?php $i=1; ?>
                                  @foreach ($data as $item)
                                    <tr class="hover:bg-slate-200 dark:hover:bg-slate-700">
                                        ...
                                        <td class="table-td">{{ $item['nama_sub_skpd'] }}</td>
                                        <td class="table-td">{{ $item['nomor_spm'] }}</td>
                                        <td class="table-td">{{ $item['tanggal_spm'] }}</td>
                                        <td class="table-td">{{ $item['nomor_sp_2_d'] }}</td>
                                        <td class="table-td">{{ $item['tanggal_sp_2_d'] }}</td>
                                        <td class="table-td">{{ $item['jenis_sp_2_d'] }}</td>
                                        <td class="table-td">{{ $item['keterangan_sp_2_d'] }}</td>
                                        <td class="table-td">{{ $item['nilai_sp_2_d'] }}</td>
