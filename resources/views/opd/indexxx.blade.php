                            ...
                            <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700 data-table">
                              ...
                              <body>
                                ...
                                function rupiah($angka){
                                  ...
                                  $nomordok = $_GET['id'];
                                  $curl = curl_init();
                                  $url = "https://service.sipd.kemendagri.go.id/pengeluaran/strict/spm/cetak/$nomordok";
                                  ...
                                  curl_setopt_array($curl, array(
                                    ...
                                    CURLOPT_HTTPHEADER => array(
                                      'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..kQoxdyKkPjp5KWxebhn9sE94bP0SDQ49k6ehdLcLodI'
                                    ),
                                  ));
                                ...
                                <tr class="hover:bg-slate-200 dark:hover:bg-slate-700">
                                  ...
                                  <tr>
                                    ...
                                    <td ><?= $row1['nilai_spp_pajak_potongan']; ?></td>
                                  </tr>
                                  @endforeach
