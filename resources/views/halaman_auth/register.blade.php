	...
	<div class="limiter">
		<div class="container-login100">
          ...
          <div style="margin: 20px 20px 40px 20px;">
                <label for="gambar" style="margin: bottom 10px; font: size 16 pt; color:#666666">Gambar</label>
...
<!--===============================================================================================-->
	<script src="{{ asset('halaman_auth/or/daterangepicker/moment.min.js') }}vend"></script>
