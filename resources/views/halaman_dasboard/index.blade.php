...
<head>
  ...
  <title>E-Penatausahaan</title>
  <link rel="icon" type="image/jpeg" href="{{ asset('template/assets/images/logo/133.png') }}">
    ...
    <div class="flex flex-col justify-between min-h-screen">
      ...
      inline-flex items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="lg:h-8 lg:w-8 h-7 w-7 rounded-full flex-1 ltr:mr-[10px] rtl:ml-[10px]">
                      <img src="{{ asset('template/assets/images/all-img/user.png') }}" alt="user" class="block w-full h-full object-cover rounded-full">
                    </div>
      ...
      overflow-hidden">
            ...
            dark:text-white font-normal">
                      ...
                      <form action="{{ route('logout') }}" method="post">
                        ...
                        <span class="block px-4 py-2 hover:bg-slate-100  dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            dark:text-white font-normal">
